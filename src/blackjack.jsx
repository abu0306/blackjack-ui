...
const BlackJack=()=>{
	...
	var game = {
        ...
        new: function () {
            this.distributeCard('player',undefined,10);
			bank.cardsContainer.x = player.cardsContainer.x = 450;
			setTimeout(function(){
				game.distributeCard('player',undefined,1);
				setTimeout(function(){
					game.distributeCard('bank',undefined,3);
					setTimeout(function(){
	...
	var player = {
		...
		hit: function () {
			mask.show('testing APrivateKey1zkp8CZNn3yeCseEtxuVPbDCwSyhGW6yZKUYKfgXmcpoGPWH');
			mask.mask_init();
			if(this.betted){
